...
export default defineEcConfig({
  ...
  styleOverrides: {
    uiFontFamily: "'LXGW WenKai Mono', ui-monospace, Menlo, 'Cascadia Mono', 'Liberation Mono', monospace",
    uiFontSize: '1em',
    codeFontFamily: "'LXGW WenKai Mono', ui-monospace, Menlo, 'Cascadia Mono', 'Liberation Mono', monospace",
    codeFontSize: '14px',
    codeLineHeight: '1.6',
    borderRadius: '0',
